...
export default function StudentsScreen({ navigation }) {
  ...
  const studentsData = [
    { id: '1', name: 'Luis Pérez', course: 'Matemáticas', average: 85, risk: 'Bajo' },
    { id: '2', name: 'Ana García', course: 'Física', average: 70, risk: 'Medio' },
    { id: '3', name: 'Carlos Ramírez', course: 'Química', average: 60, risk: 'Alto' },
    { id: '4', name: 'María López', course: 'Biología', average: 90, risk: 'Bajo' },
    { id: '5', name: 'Juan Torres', course: 'Historia', average: 75, risk: 'Medio' },
  ];

  const filteredStudents = studentsData.filter((student) => {
    const matchesSearch = student.name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchesRisk = selectedRiskLevel ? student.risk === selectedRiskLevel : true;
